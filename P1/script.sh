...
if [ "$MAIN_NAME" = "main" ]
then
  ficherosEntrada=("script_minimos/new" "script_minimos/play" "script_minimos/delete1" "script_minimos/delete2")
  ficherosRef=("script_minimos/new_ref" "script_minimos/play_ref" "script_minimos/delete1_ref" "script_minimos/delete2_ref")
else
  ficherosEntrada=("")
